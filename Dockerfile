...
ENV HUGO_CHECKSUM b65edbe09f6ca6f580213e20492e899a7fee3b60ed1e2f1a057c7baa500f387b
...
RUN wget -q https://github.com/gohugoio/hugo/releases/download/v0.63.1/hugo_extended_0.63.1_Linux-64bit.tar.gz && \
    echo "${HUGO_CHECKSUM}  hugo_extended_0.63.1_Linux-64bit.tar.gz" | sha256sum -cs - && \
    tar xfz hugo_extended_0.63.1_Linux-64bit.tar.gz && \
    mv /tmp/hugo /usr/bin && \
    rm -rf /tmp/* && \
    mkdir /site
