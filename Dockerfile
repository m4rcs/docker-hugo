...
ENV HUGO_CHECKSUM 150d9a75e6d47f3196d9972846c3828170f746f1f2e904da2732a411dc54dd38
...
RUN wget -q https://github.com/gohugoio/hugo/releases/download/v0.49/hugo_extended_0.49_Linux-64bit.tar.gz && \
    echo "${HUGO_CHECKSUM}  hugo_extended_0.49_Linux-64bit.tar.gz" | sha256sum -cs - && \
    tar xfz hugo_extended_0.49_Linux-64bit.tar.gz && \
    mv /tmp/hugo /usr/bin && \
    rm -rf /tmp/* && \
    mkdir /site
