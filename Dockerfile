...
ENV HUGO_CHECKSUM 0cf66ec50b087d18ef80466e45d6d590375237706a2bb09effa263138ae426dc
...
RUN wget -q https://github.com/gohugoio/hugo/releases/download/v0.55.1/hugo_extended_0.55.1_Linux-64bit.tar.gz && \
    echo "${HUGO_CHECKSUM}  hugo_extended_0.55.1_Linux-64bit.tar.gz" | sha256sum -cs - && \
    tar xfz hugo_extended_0.55.1_Linux-64bit.tar.gz && \
    mv /tmp/hugo /usr/bin && \
    rm -rf /tmp/* && \
    mkdir /site
